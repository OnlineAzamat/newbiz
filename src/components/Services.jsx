const Services = () => {
  return (
    <div className="bg-[#ECF5FF] box-shadow-service px-[10%] py-[6rem]">
      ...
      <div className="py-16 grid grid-cols-2 gap-x-16 gap-y-8">
        <div className="flex flex-col gap-4 py-8 pl-16 pr-8 bg-white rounded-xl shadow-xl transition-all cursor-pointer hover:shadow-md hover:opacity-75">
